#pragma checksum "D:\Workspace\source\repos\Agile\Presentation\Agile.Web\Areas\Admin\Views\Plugin\List.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "baa796d3636a23ff6b625fd41184ab1f0bd9b01a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"baa796d3636a23ff6b625fd41184ab1f0bd9b01a", @"/Areas/Admin/Views/Plugin/List.cshtml")]
        ...
        layui.use(['layer', 'form', 'table', 'util', 'admin', 'xmSelect'], function () {
         ...
         ");
                    ...
                    { field: 'state', title: '当前状态', sort: true },
                    {
                        field: 'restartState', title: '重启状态', sort: true, templet: function (d) {
                            ...
                            if (d.restartState === d.state) {
                                return '<span class=""layui-badge layui-badge-green"">保持当前");
            ...
            function doInstall(systemName) {
                $.get('/admin/plugin/inst");
                WriteLiteral(@"all', { systemName: systemName }, function (res) {
                    if (res.code === 0) {
